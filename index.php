        ...
        <div class="card-body">
          <p>
            <h5>
    				...
    				After joining the STUDENT EXCHANGE PROGRAMME, he continued to study in <a href="http://cs.utaipei.edu.tw">Computer Science</a> at <a href="http://www.utaipei.edu.tw/">University of Taipei</a>. He got<button type="button" class="btn btn-link btn-lg" data-toggle="modal" data-target="#MOSTModal">College Student Research Scholarship, MOST</button>in 2018.
            </h5>
          </p>
          <p>
            <h5>
