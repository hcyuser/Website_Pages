...
<div class="container">
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        <td>A Corpus Analysis of Representation of South-Asia Migrant Workers in Taiwan Newspaper<span class="badge badge-primary">Conference Proceedings</span></td>
      ...
      <tr>
        <td><a href="https://sitcon.org/2018/">SITCON 2018</a><span class="badge  badge-warning">Conference Talks</span></td>
        <td>Speaker</td>
      </tr>
      <tr>
        <td>A Study on Modeling and Classification of the Student Opinion Survey with Word2vec<span class="badge badge-primary">Conference Proceedings</span></td>
        <td><p>Author:<br>Chih-yang Huang(黃志揚), Yen-Hung Chen(陳彥宏), Mei-Ching Ho(何美靜)</p>
        <a href="#">[Paper]</a><a href="#">[Slides]</a>
        <p>In <a href="http://par.cse.nsysu.edu.tw/~algo/">The 35th Workshop on Combinatorial Mathematics and Computation Theory</a>,Providence University,Taichung</p></td>
      </tr>
    </tbody>
  </table>
</div>
