...
<div class="container">
  ...
  <table id="PP"  class="table table-striped table-bordered" style="width:100%">
    ...
    <tbody>
      ...
      <tr>
        <td>2018<span class="badge badge-info"> Coming Soon</span></td>
        <td><span class="badge badge-primary">Conference Proceedings</span></td>
        <td>A Measure & Conquer Algorithm for the Minimum User Spatial-aware Interest Group Query Problem</td>
